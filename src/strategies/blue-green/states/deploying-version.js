var Q = require('q'), _ = require('lodash'), randtoken = require('rand-token'), l = require('../../../lib/logger.js'), EventLogger = require('../../../lib/environment-event-logger'), helpers = require('../../../lib/helpers');
