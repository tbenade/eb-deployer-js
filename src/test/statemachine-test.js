...
describe("StateMachine", function () {
    ...
    describe("when executing a transition", function () {
        it("should trigger the generic events for state exit, entry and change", function () {
            ...
            getStateMachine().bind(FSM.EXIT, logState("exit")).bind(FSM.ENTER, logState("enter")).bind(FSM.CHANGE, logState("change")).run().doAction("close");
        ...
        it("should trigger transition events for each state", function () {
            ...
            getStateMachine().bind("open.exit", logState("open.exit")).bind("closed.enter", logState("closed.enter")).bind("closed.change", logState("closed.change")).run().doAction("close");
